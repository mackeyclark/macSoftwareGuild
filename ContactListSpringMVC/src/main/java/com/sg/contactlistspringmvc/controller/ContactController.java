...
public class ContactController {
    ...
    public String displayContactsPage(Model model) {
        //get all the contacts form the dao
    ...
    public String createContact(HttpServletRequest request){
        ...
        //persist to new contact
        dao.addContact(contact);
        
        //we don't want to foward to a View component - we want to redirect to
        //the endpoint that displays the contact page so it can display the new

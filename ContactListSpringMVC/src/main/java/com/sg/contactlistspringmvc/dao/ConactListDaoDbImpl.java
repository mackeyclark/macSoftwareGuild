 ...
 * @author macam
 */
public class ConactListDaoDbImpl implements ContactListDao {
    ...
    public Contact addContact(Contact contact) {
        ...
        // row in the database
        int newId = jdbcTemplate.queryForObject("select LAST_INSET_ID()", Integer.class);
    ...
    public List<Contact> searchContacts(Map<SearchTerm, String> criteria) {
        if (criteria.isEmpty()) {
            ...
            // build a prepared statment based on the user's search terms
    ...
    private static final class ContactMapper implements RowMapper<Contact> {
        ...
        public Contact mapRow(ResultSet rs, int rpwNum) throws SQLException {

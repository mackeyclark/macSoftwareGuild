...
public class Contact {
    ...
    @NotEmpty(message = "You Must Enter a value for First Name.")
    @Length(max = 50, message = "First name must be no more than 50 characters in length.")
    private String firstName;
    @NotEmpty(message = "You Must Enter a value for Last Name.")
    @Length(max = 50, message = "Last namemust be no more than 50 characters in length.")
    private String lastName;
    @NotEmpty(message = "You Must Enter a value for Company.")
    @Length(max = 50, message = "Company must be no more than 50 characters in length.")
    private String company;
    @NotEmpty(message = "You Must Enter a value for Phone.")

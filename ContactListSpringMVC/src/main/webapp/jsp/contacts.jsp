<%-- 
    Document   : contacts
    Created on : Sep 26, 2018, 3:21:09 PM
    Author     : macam
--%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <!--
                add a row to our container - this will hold the summary table
                and the new contact form
            -->

            <div class="row">
                <!--
                    add a col to hold the summary table - have it take up half 
                    the row
                -->
                <div class="col-md-6">
                    <h2>My Contacts</h2>
                ...
                <!--
                    add col to hold the new contact form - have it take up the

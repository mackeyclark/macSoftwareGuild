...
public class FlooringCalculatorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String lengthInput = request.getParameter("lengthInput");
        String widthInput = request.getParameter("widthInput");
        String materialInput = request.getParameter("materialCost");
        double length = Double.parseDouble(lengthInput);
        double width = Double.parseDouble(widthInput);
        double materialCost = Double.parseDouble(materialInput);

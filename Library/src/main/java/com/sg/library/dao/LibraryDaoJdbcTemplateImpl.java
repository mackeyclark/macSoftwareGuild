...
public class LibraryDaoJdbcTemplateImpl implements LibraryDao {
    ...
    private static final String SQL_DELETE_BOOKS_AUTHORS
            = "delete from books_authors where books = ?";
    ...
    private static final String SQL_BOOKS_AUTHORS_AUTHOR_ID_BY_BOOK_ID
    ...
    private static final String SQL_INSERT_PUBLISHER
            = "insert into (name, street, city, state, zip, phone) "
            + "values (?, ?, ?, ?, ?, ?)";
    ...
    public List<Book> getBooksByAuthorId(int authorId) {
        ...
        return associatePublisherAndAuthorsWithBook(bookList);
    }
    ...
    private List<Book> associatePublisherAndAuthorsWithBook(List<Book> bookList) {
        ...
        for (Book currentBook : bookList) {
            ...
            // add the publishers to current book
    ...
    private static final class AuthorMapper implements RowMapper<Author> {
        ...
        public Author mapRow(ResultSet rs, int i) throws SQLException {
            ...
            au.setFirstName(rs.getString("last_name"));

            ...
            <div class="col-md-8">
                <div id="buttonDiv">
                    <c:forEach var="currentItem" items="${itemList}">
                        <button type="button" class="btn btn-block" id="item" onclick="saveName({currentItem.name})"><c:out value="${itemList.itemId}"/><c:out value="${itemList.name}"/><c:out value="${itemList.price}"/><c:out value="${itemList.inventory}"/></button>
                    </c:forEach>
                </div>
            </div>
            <div class="col-md-4">
